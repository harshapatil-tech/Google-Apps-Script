function runDisciplinaryIssues() {
  ...
  for (const dept of DEPARTMENTS) {
    new DisciplinaryIssues(dept, empDetails[dept]);
  }
}

class DisciplinaryIssues {
  ...
  _updateMasterSheet(sheet, empIdentifierRange, backendData) {
    ...
    // sheet.getRange(1, 2).setValue("UUID")
